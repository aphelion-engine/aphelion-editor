...
from gui.node_graph.constants import (
    COLOR_GRAPH_BG,
    COLOR_GRID_MAJOR,
    COLOR_GRID_MINOR,
    COLOR_MARQUEE,
...
import gui.node_graph.operations as node_ops
...
class NodeGraphView(QGraphicsView):
    ...
    def show_context_menu(self, position: QPoint) -> None:
        from gui.node_context_menu import GraphContextMenu
    ...
    def show_node_context_menu(self, global_pos: QPoint) -> None:
        from gui.node_context_menu import NodeOperationsMenu
