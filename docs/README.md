# Aphelion Editor documentation

Guides for running, using, packaging, and extending the desktop editor.
...
| [Development](development.md) | Tests, type checking, logging |

Plugin authors should start at the sibling [SDK documentation](../../aphelion-sdk/docs/README.md).
